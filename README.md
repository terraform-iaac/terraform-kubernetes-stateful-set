...
| volume\_claim | Attach Persistant Volume Claim | <pre>list(object({<br>    name  = string<br>    namespace = string<br>    access_modes = list(string)<br>    requests_storage = string<br>    storage_class_name = string<br>    persistent_volume_name = string<br>  }))</pre> | n/a | <pre>\[<br>  {<br>    name  = "app-pvc"<br>    namespace = "application"<br>    access_modes = ["ReadWriteOnce"]<br>    requests_storage = "10Gi"<br>    storage_class_name = "default"<br>    persistent_volume_name = "default"<br>  }<br>]</pre> | no |
